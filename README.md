This Python 3 (tested with 3.9.3) script builds on the  (https://github.com/alecvance/Nestlogger) script to provide additional tools to maintain your Nest thermostat. 
